...
export default function RagSourceCitationsSection() {
  return (
      ...
      <section className="bg-gray-950 py-32 border-t border-b border-white/5 relative z-10">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="bg-white/5 border border-white/10 backdrop-blur-lg p-16 rounded-3xl">
            <span className="font-mono text-xs text-indigo-400 tracking-widest uppercase mb-4 block">Component / rag_source_citations</span>
