...
export default function GrangerTestimonialsSection() {
  return (
      ...
      <section className="bg-white py-32 border-t border-b border-white/5 relative z-10">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="bg-gray-50 border border-gray-200 p-16 rounded-3xl">
            <span className="font-mono text-xs text-indigo-400 tracking-widest uppercase mb-4 block">Component / granger_testimonials</span>
            <h2 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-6">
              Granger Testimonials
            </h2>
