import React from 'react';
        ...
        export default function HeaderNavigationSection() {
          return (
              ...
              <section className="{cls['section']} py-32 border-t border-b border-white/5 relative z-10">
                ...
                <div className="max-w-4xl mx-auto px-6 text-center">
                  <div className="{cls['card']} p-16 rounded-3xl">
                    <span className="font-mono text-xs text-indigo-400 tracking-widest uppercase mb-4 block">Component / header_navigation</span>
